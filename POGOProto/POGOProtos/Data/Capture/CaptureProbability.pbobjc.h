...
@interface POGOCaptureProbabilityRoot : GPBRootObject
@end

#pragma mark - POGOCaptureProbability

typedef GPB_ENUM(POGOCaptureProbability_FieldNumber) {
  POGOCaptureProbability_FieldNumber_PokeballTypeArray = 1,
  POGOCaptureProbability_FieldNumber_CaptureProbabilityArray = 2,
  POGOCaptureProbability_FieldNumber_ReticleDifficultyScale = 12,
};

@interface POGOCaptureProbability : GPBMessage

// |pokeballTypeArray| contains |POGOItemId|
