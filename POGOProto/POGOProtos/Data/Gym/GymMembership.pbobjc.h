...
@interface POGOGymMembershipRoot : GPBRootObject
@end

#pragma mark - POGOGymMembership

typedef GPB_ENUM(POGOGymMembership_FieldNumber) {
  POGOGymMembership_FieldNumber_PokemonData = 1,
  POGOGymMembership_FieldNumber_TrainerPublicProfile = 2,
};

@interface POGOGymMembership : GPBMessage
