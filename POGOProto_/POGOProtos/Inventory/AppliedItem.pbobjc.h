...
@interface POGOAppliedItemRoot : GPBRootObject
@end

#pragma mark - POGOAppliedItem

typedef GPB_ENUM(POGOAppliedItem_FieldNumber) {
  POGOAppliedItem_FieldNumber_ItemId = 1,
  POGOAppliedItem_FieldNumber_ItemType = 2,
  POGOAppliedItem_FieldNumber_ExpireMs = 3,
  POGOAppliedItem_FieldNumber_AppliedMs = 4,
};

@interface POGOAppliedItem : GPBMessage
...
/// Fetches the raw value of a @c POGOAppliedItem's @c itemId property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t POGOAppliedItem_ItemId_RawValue(POGOAppliedItem *message);
/// Sets the raw value of an @c POGOAppliedItem's @c itemId property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
void SetPOGOAppliedItem_ItemId_RawValue(POGOAppliedItem *message, int32_t value);

/// Fetches the raw value of a @c POGOAppliedItem's @c itemType property, even
/// if the value was not defined by the enum at the time the code was generated.
int32_t POGOAppliedItem_ItemType_RawValue(POGOAppliedItem *message);
/// Sets the raw value of an @c POGOAppliedItem's @c itemType property, allowing
/// it to be set to a value that was not defined by the enum at the time the code
/// was generated.
