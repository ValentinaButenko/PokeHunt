...
@interface POGOClaimCodenameMessageRoot : GPBRootObject
@end

#pragma mark - POGOClaimCodenameMessage

typedef GPB_ENUM(POGOClaimCodenameMessage_FieldNumber) {
  POGOClaimCodenameMessage_FieldNumber_Codename = 1,
};

@interface POGOClaimCodenameMessage : GPBMessage
