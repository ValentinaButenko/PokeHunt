...
@interface POGOIncenseEncounterMessageRoot : GPBRootObject
@end

#pragma mark - POGOIncenseEncounterMessage

typedef GPB_ENUM(POGOIncenseEncounterMessage_FieldNumber) {
  POGOIncenseEncounterMessage_FieldNumber_EncounterId = 1,
  POGOIncenseEncounterMessage_FieldNumber_EncounterLocation = 2,
};

@interface POGOIncenseEncounterMessage : GPBMessage
