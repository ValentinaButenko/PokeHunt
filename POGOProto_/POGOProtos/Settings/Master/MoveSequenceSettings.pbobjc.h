...
@interface POGOMoveSequenceSettingsRoot : GPBRootObject
@end

#pragma mark - POGOMoveSequenceSettings

typedef GPB_ENUM(POGOMoveSequenceSettings_FieldNumber) {
  POGOMoveSequenceSettings_FieldNumber_SequenceArray = 1,
};

@interface POGOMoveSequenceSettings : GPBMessage
