...
@interface POGOPlayerLevelSettingsRoot : GPBRootObject
@end

#pragma mark - POGOPlayerLevelSettings

typedef GPB_ENUM(POGOPlayerLevelSettings_FieldNumber) {
  POGOPlayerLevelSettings_FieldNumber_RankNumArray = 1,
  POGOPlayerLevelSettings_FieldNumber_RequiredExperienceArray = 2,
  POGOPlayerLevelSettings_FieldNumber_CpMultiplierArray = 3,
  POGOPlayerLevelSettings_FieldNumber_MaxEggPlayerLevel = 4,
  POGOPlayerLevelSettings_FieldNumber_MaxEncounterPlayerLevel = 5,
};

@interface POGOPlayerLevelSettings : GPBMessage
